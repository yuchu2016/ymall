 ...
 * @Author: yuchu
 * @Description:
 * @Date: Create in 19:52  2017/10/24
 * @Modified By:
 */
@Controller
...
public class OrderController {
    ...
    public Object alipayCallback(HttpServletRequest request){
        ...
        //非常重要，验证回掉的正确性，是不是支付宝发的，并且要避免重复通知

        params.remove("sign_type");
        try {
            boolean alipayRSAChechedV2 = AlipaySignature.rsaCheckV2(params, Configs.getAlipayPublicKey(),"utf-8",Configs.getSignType());
            if (!alipayRSAChechedV2){
